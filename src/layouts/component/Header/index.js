...
// bind ob styles vào . Sẽ trả ra method là cx . lấy cx dùng class để dùng - trong class
const cx = classNames.bind(styles);
// đặt hằng cho từng children trong Menu.
const MENU_ITEMS = [
    {
        icon: <FontAwesomeIcon icon={faLanguage}></FontAwesomeIcon>,
        title: 'English',
        // cứ object nào có children thì có sub menu
        children: {
            title: 'Language',
            data: [
                {
...
function Header() {
    ...
    // nếu  current menu là true thì dùnng userMenu ngc lại dùng MenuItems
    const userMenu = [
        {
        ...
        <header className={cx('wrapper')}>
            <div className={cx('inner')}>
                ...
                <div className={cx('action')}>
                    {currentUser ? (
                        <div>
                            <Tippy delay={[0, 50]} content="Video Upload" placement="bottom">
                        ...
                        <div>
                            ...
                            <Buttons primary rightIcon={<FontAwesomeIcon icon={faSignIn} />}>
                                Login
                            </Buttons>
                        </div>
                    )}

                    {/* Check user click vào */}
                    <Menu items={currentUser ? userMenu : MENU_ITEMS} onChange={handleMenuChange}>
                        {currentUser ? (
                            <Image
                                className={cx('user-avatar')}
                                src="https://p16sign-useast2a.tiktokcdn.com/tos-useast2a-avt-0068-giso/bb39f96ae7937129de6b19824c42851f~c5_100x100.jpeg?x-expires=1698120000&x-signature=HDua%2Bf4MqOGSfPn2mxzNwwVgBJ0%3D"
                                alt="Nguyen Van A"
                                // chúng ta có thể custom nếu image bị lỗi ảnh sẽ  thay bằng ảnh khác bằng cách truyền prop vào
